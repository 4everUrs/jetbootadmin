...
<body>
    ...
    With due respesct, I would like to state that I am working in <u> Project Management Department </u> of your
    company.
    <u>Tech-Trendz Services</u>.<br><br>

    Respected, I am writing this letter to you in order to seek permission for project
    <u>{{$proposalDetail->title}}</u>. I
    have
