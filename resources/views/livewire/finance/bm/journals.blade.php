                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" >
                            ...
                            <button wire:click="updateLiabilities({{$journal_entry->id}})"  class="btn btn-primary"> Edit </button>
    ...
    <x-jet-dialog-modal wire:model="addLiability" maxWidth="xl">
        ...
        <x-slot name="content">
            <div class="row form-group"> {{--sobra kalang ng divs pwede naman pagsamahin ung dalawa sa isang div--}}
                ...
                <select class="form-control" wire:model="category"> <br>
                ...
                <label>Credit</label>&nbsp &nbsp 
                <input type="number" >&nbsp &nbsp<label>Credit</label> <input type="number" >
                </div>
