        ...
        <div class="card-body">
            <x-table head="Buyers List">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center align-middle">{{$buyer->order_id}}</td>
                        <td style="width: 20%" class="text-center align-middle">
                            @foreach ($buyer->Order->OrderItem as $item)
                                <li>
                                    {{$item->item_name}}
                                </li>
                            @endforeach
                        ...
                        <td class="text-center align-middle">
                            <button wire:click='loadModal({{$buyer->id}})'
                                class="btn btn-dark btn-sm">Confirm</button>
                        </td>
                    </tr>
                            ...
                            <div class="input-group">
                                <div class="col">
                                    <div class="form-check">
                                        <input value="confirmed" wire:model="status" class="form-check-input"
                                            type="radio">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input value="preparing" wire:model="status" class="form-check-input"
                                            type="radio">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input value="shipping" wire:model="status" class="form-check-input"
                                            type="radio">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input value="transit" wire:model="status" class="form-check-input"
                                            type="radio">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input value="delivered" wire:model="status" class="form-check-input"
                                            type="radio">
