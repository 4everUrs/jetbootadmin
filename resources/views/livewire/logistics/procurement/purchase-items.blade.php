<div>
   <x-slot name="header">
    ...
    <div class="card-body">
        <button wire:click='back' class="btn btn-danger float-lef">Back</button>
        <button class="btn btn-secondary float-right">Print</button>
        <button class="btn btn-primary float-right mr-2">Download</button>    
    </div>
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="spreadSheetGroup">
                        ...
                        <table class="shipToFrom mt-4">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width:50%">
                                       Name:{{$suppliers->name}}<br/>
                                       Location:{{$suppliers->address}}<br/>
                                       Email:{{$suppliers->email}}<br/>
                                       Contact:{{$suppliers->phone}}<br/>
                                    </td>
                                    <td style="width:50%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="text-align:left">
                                                        ...
                                                        <p>3. Please notify us immediately if you are unable to ship as specified.
                                                        </p>
