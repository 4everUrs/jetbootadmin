<aside class="control-sidebar control-sidebar-dark" style="top: 57px; display: block;">
    ...
    <div class="p-3 control-sidebar-content os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-host-overflow os-host-overflow-y"
        ...
        <div class="os-content-glue" style="margin: -16px; width: 249px; height: 211px;"></div>
        ...
        <div class="os-scrollbar os-scrollbar-vertical">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="transform: translate(0px, 0px); height: 16.4087%;"></div>
            </div>
        </div>
